    ...
    Here's a sample configuration:
      ...
      - name: poetry-slams-servicebroker
        ...
        properties:
          ...
          #SBF_BROKER_CREDENTIALS: '{ "<BrokerUser>": "<plain-broker-password>" }'      # alternatively: use command  "npx hash-broker-password -b" to generate a random password and use the plain password here
          SBF_SERVICE_CONFIG:
            psm-servicebroker:
              extend_xssecurity:
                per_plan:
