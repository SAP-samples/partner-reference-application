...
For general guidelines on how to connect your local test against services in the Cloud, refer to the SAP Cloud Application Programming Model documentation [on hybrid testing](https://cap.cloud.sap/docs/tools/cds-bind).
